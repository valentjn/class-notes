...
\begin{Def}{Einheitssimplex}
    ...
    heißt \begriff{Einheitssimplex} oder \begriff{Referenzelement} $\widehat{T}$ in $\real^d$.
\end{Def}
...
\begin{Def}{Triangulierung}
    ...
    $\varrho := \min_{i \in I} \varrho_{T_i}$ \begriff{minimaler Inkugelradius} von $\T_h$ und
