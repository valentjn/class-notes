...
\begin{Def}{links-/rechtsorthogonal}
    ...
    \begriff{rechtsorthogonal} zu $x$, falls $\innerproduct{x, y} = 0$.
...
\begin{Def}{Links-/Rechtsradikal}
    ...
    heißt \begriff{Rechtsradikal} der Bilinearform $\innerproduct{\cdot, \cdot}$.
\end{Def}
...
\begin{Def}{spezielle Bilinearformen}
    ...
    $\innerproduct{\cdot, \cdot}$ heißt \begriff{symmetrisch}, falls
    $\innerproduct{v_1, v_2} = \innerproduct{v_2, v_1}$ für alle $v_1, v_2 \in V$. \\
    $\innerproduct{\cdot, \cdot}$ heißt \begriff{alternierend}, falls
    $\innerproduct{v_1, v_2} = -\innerproduct{v_2, v_1}$ für alle $v_1, v_2 \in V$.
\end{Def}
